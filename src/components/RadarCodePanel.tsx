  ...
  return (
    <div className="glass-panel p-3 w-full">
      <div className="flex justify-between items-center mb-2">
        <span className="text-[17.5px] font-mono text-primary uppercase tracking-wider">
          RDA {scanAngle.toFixed(1)}°
        </span>
        <span className="text-[17.5px] font-mono text-neon-green uppercase flex items-center gap-1">
        ...
        <div className="flex gap-0.5 flex-wrap flex-1">
          {tiltAngles.map((a) => (
            <button
              ...
              className={`px-1 py-0.5 text-[12.5px] font-mono rounded-sm transition-colors ${
                scanAngle === a
      ...
      <div className="flex items-center gap-2">
        <span className="text-[12.5px] font-mono text-muted-foreground w-8">SPD</span>
        <Slider
          value={[speed]}
          ...
          className="flex-1"
        />
        <span className="text-[12.5px] font-mono text-primary w-10 text-right">{(speed / 1000).toFixed(1)}s</span>
      </div>
    </div>
  );
};
