...
// ─────────────────────────────────────────────────────────────────────────
// SPC Bot system message card
// ─────────────────────────────────────────────────────────────────────────
// The bot stores a structured payload inside an HTML-comment marker:
...
function SystemMessageCard({
  ...
  // Strip all hidden markers and grab just the header line for display.
  ...
  return (
    ...
    >
      ...
      {payload ? (
        ...
        // Legacy / unparseable fallback — show plain text minus header.
