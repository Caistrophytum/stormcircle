...
const LocationPicker = ({ userId, currentLocation, onSaved }: Props) => {
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2 text-sm font-mono text-card-foreground">
      ...
      <div className="relative">
        <input
          ...
          maxLength={80}
          placeholder="Search a city to set as home..."
      ...
      {pending && (
        <div className="flex items-center gap-2 pt-1">
          ...
          <button
            ...
            disabled={saving}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-primary text-primary-foreground font-mono text-[10px] font-bold uppercase tracking-wider rounded-sm hover:brightness-110 transition-all disabled:opacity-60"
          >
          ...
          <button
            ...
            disabled={saving}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-secondary text-card-foreground font-mono text-[10px] font-bold uppercase tracking-wider rounded-sm hover:brightness-110 transition-all"
          >
            Cancel
          </button>
        </div>
