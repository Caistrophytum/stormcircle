...
function rowToAlert(r: AlertRow): Alert {
  ...
  // Country provenance: MeteoAlarm rows are prefixed "MA-<CC>-" by the
  // European poller (Israel included), everything else in `active_alerts`
  // comes from the NWS (United States).
  const country = r.alert_id?.startsWith("MA-")
