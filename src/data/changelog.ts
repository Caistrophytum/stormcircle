...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: "A simple and intuitive window aiming to use environmental factors, as well as warnings, watches, alerts, and outlooks, in order to try and pinpoint the best (and worst) times to exercise. Including walking, running, biking, hiking, and outdoor calisthenics.",
  },
  {
    date: "2026-07-01 05z",
    tag: "NEW",
