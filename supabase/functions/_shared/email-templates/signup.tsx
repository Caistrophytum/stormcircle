...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your Strato.Ops account</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          <Text style={brand}>STRATO.OPS</Text>
          <Text style={tagline}>// AVIONICS COMMAND DECK</Text>
        </Section>
        ...
        <Text style={text}>
          Verify your email to complete clearance and access the deck:
        </Text>
        ...
        <Text style={footer}>
          If you didn't request this clearance, disregard this transmission.
        </Text>
      </Container>
    </Body>
  </Html>
